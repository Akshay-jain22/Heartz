    ...
    return (
        <>
            <div className='row' style={{ height:'auto',paddingTop: '4vh' }}>
                ...
                <div className='col' style = {{paddingTop: '2.5vh'}}>
                    <div classname = 'row'>
                    <h2><u>Why is Heartz built?</u> </h2>
                    </div>
                    <div className='row'>
                        <p style={{ fontSize :'2.3ex' }}>Heartz creates simple and understandable notes from audio recordings. 
                        This platform helps students, office workers, teachers and others in making notes from online meetings.</p>
                    </div>
                </div>
            </div>
            ...
            <div className='row' style = {{textAlign:'justify',fontSize :'2.3ex' }}>
                <p>In our present world, communication plays a key role in our daily progress.
                        ...
                        Heartz is developed to help in these situation of speech to pdf conversion. This helps
                        many students, office workers, teachers and others in making notes from online meetings.</p>
                <br></br>
            </div>
            <div classname = 'row' style={{ height:'5vh'}}></div>
            <div className='row' style = {{textAlign: 'justify'}}>
                <div classname = 'row'><h2><u>What is different in Heartz?</u></h2></div>
                    <div classname = 'row' style={{ height:'5vh'}}></div>
                    <div className = 'row'>
                        <div className='col'>
                        ...
                        <div className='col'>
                            <div classname = 'row'>
                                ...
                                <p style={{ fontSize :'1.8ex' }}>As there are many formats for audio, we are providing the user with multiple formats like mp3,  aac, wav, etc.
                                Video uploading format is also provided for better user experience, wherein we can upload videos from multiple formats like mp4, mkv, mov.
                                URL link format is also provided for ease use for users, wherein if the user needs to make notes of the online video, then providing the link will do the job. </p>

                        </div> 
                        </div>
                    </div>
                    <div classname = 'row' style={{ height:'4vh'}}></div>
                    <div className = 'row'>
                        <div className='col'>
                            <div classname = 'row'>
                                <h2>Hyperlinks</h2>
                            ...
                            <div className='row'>
                                <p style={{ fontSize :'1.8ex' }}>In the final document file generated, it contains many hyperlinks which will make for a better user experience. 
                                These hyperlinks are generated for the words for better understanding and for the important topics mentioned in the audio recordings. </p>
                    ...
                    <div className = 'row'>
                        ...
                        <div className='col'>
                            <div classname = 'row'>
                                ...
                                <p style={{ fontSize :'1.8ex' }}>The recordings may contain multiple speakers; 
                                ...
                                speakers are identified and mentioned accordingly with the available speaker conventions
                                 like speaker 1, speaker 2 etc.</p>
                    ...
                    <div className = 'row'>
                        ...
                        <div className='col'>
                            <div classname = 'row'>
                                <h2>Accuracy</h2>
                                <p style={{ fontSize :'1.8ex' }}>There is also an option for comparing the 
                                generated file with the original available file to find the accuracy of our generated pdf file.</p>
